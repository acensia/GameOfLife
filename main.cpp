...
int main(int argc, char** argv) {
  ...
  glutTimerFunc(1000 / FPS, timerCallback,
                0);  // bind glut timer callback funcs
...
void init() {
  glClearColor(0.2f, 0.3f, 0.6f,
               1.0f);  // background color(the border line color)
